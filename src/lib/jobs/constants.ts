...
// Location dropdown offers (see COUNTRY_OPTIONS below for the specific-city
// field that actually drives search targeting).
export const LOCATION_OPTIONS = ["Egypt"];

// The four cities the "Country" field offers. Full governorate names (not
// abbreviations like "Alex") so they match EGYPT_GOVERNORATES/
...
export const COUNTRY_OPTIONS = ["Cairo", "Alexandria", "Giza", "Suez"];
