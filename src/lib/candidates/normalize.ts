 ...
 * provider actually returned. `experience_years` is null unless a structured
 * source (e.g. an Apify LinkedIn profile enrichment) supplied one — search
 * snippets never contain a reliable, structured years-of-experience figure,
 * and guessing one from free text would risk fabricating candidate
 * information, which is never acceptable.
 */
